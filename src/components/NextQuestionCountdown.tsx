    ...
    return (
      <div className={`w-full bg-[#26134B]/95 border border-amber-400/40 rounded-[2px] p-3 shadow-xl backdrop-blur-md text-white animate-fadeIn ${className}`}>
        <div className="flex items-center justify-between gap-2 mb-2">
          ...
          <span className={`font-mono font-black text-sm px-2 py-0.5 rounded-[2px] border ${
            isUrgent 
  ...
  return (
    <div className={`w-full max-w-xl mx-auto fluent-acrylic-surface border-2 ${
      ...
      <div className="flex items-center justify-between gap-3 mb-3">
        ...
        {/* Big Time Badge */}
        <div className={`shrink-0 font-mono font-black text-xl sm:text-2xl px-3 sm:px-4 py-1.5 rounded-[2px] border shadow-lg ${
          isUrgent
