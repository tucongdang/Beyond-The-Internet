...
export const QrDiagnosticOverlay: React.FC<QrDiagnosticOverlayProps> = ({
  ...
  return (
    <div
      ...
      className="absolute inset-0 bg-[#0c0418]/95 backdrop-blur-md rounded-[4px] z-50 p-4 sm:p-5 flex flex-col justify-between overflow-y-auto animate-fadeIn select-none border-2 border-sky-400/40 text-left font-sans"
      onClick={(e) => e.stopPropagation()}
    >
      {/* Header Bar */}
      <div className="flex items-center justify-between pb-2.5 mb-2.5 border-b border-white/10 shrink-0">
        <div className="flex items-center gap-2">
          <div className={`p-1.5 rounded-[2px] ${isHealthy ? 'bg-emerald-500/20 text-emerald-300' : 'bg-rose-500/20 text-rose-300'}`}>
          ...
          <div>
            <h4 className="text-xs sm:text-sm font-black font-mono tracking-wide text-white uppercase flex items-center gap-1.5">
              ...
              <span className="px-1.5 py-0.2 rounded-[2px] bg-sky-500/20 text-sky-300 text-[10px] font-mono">v2.6</span>
            </h4>
      ...
      <div className="flex-1 space-y-3 overflow-y-auto pr-1 text-xs">
        ...
        <div
          ...
          className={`p-3 rounded-[2px] border flex items-start justify-between gap-3 ${
            isHealthy
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <div className="font-bold text-xs flex items-center gap-2">
                ...
                <span className="font-mono uppercase font-black px-1.5 py-0.5 rounded-[2px] bg-black/40 text-white">
              ...
              <div className="text-[11px] font-mono mt-0.5 flex items-center gap-1.5">
                ...
                <span
                  className={`font-black px-1.5 py-0.5 rounded-[2px] ${
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="p-2.5 rounded-[2px] bg-black/30 border border-white/10 flex items-center justify-between">
            <div className="flex items-center gap-2">
              {data.isOnline ? (
        ...
        <div className="fluent-box-nested p-3 rounded-[2px] border border-white/10 space-y-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-[11px] font-mono">
            <div className="p-1.5 rounded-[2px] bg-black/20">
          ...
          <div className="mt-2 pt-1 border-t border-white/10">
            ...
            <div className="p-2 rounded-[2px] bg-black/50 border border-white/10 font-mono text-[10px] text-sky-200 break-all select-all max-h-16 overflow-y-auto">
              {data.targetUrl}
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {onRetest && (
            <button
              ...
              className="px-2.5 py-1.5 rounded-[2px] bg-white/10 hover:bg-white/20 text-white font-mono text-[11px] font-bold transition active:scale-95 flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-[2px] font-mono text-[11px] font-bold transition active:scale-95 flex items-center gap-1.5 cursor-pointer ${
              copiedLog
