    ...
    switch (type) {
      case 'URGENT':
        return {
          ...
          badgeText: localLanguage !== 'vi' ? 'EMERGENCY NOTICE' : 'CHÚ Ý KHẨN CẤP',
      ...
      case 'ALERT':
        return {
          ...
          badgeText: localLanguage !== 'vi' ? 'IMPORTANT NOTICE' : 'LƯU Ý QUAN TRỌNG',
      ...
      case 'CELEBRATION':
        return {
          ...
          badgeText: localLanguage !== 'vi' ? 'EVENT & HONORS' : 'VINH DANH & SỰ KIỆN',
      ...
      default:
        return {
          ...
          badgeText: localLanguage !== 'vi' ? 'ORGANIZER ANNOUNCEMENT' : 'THÔNG BÁO TỪ BTC',
